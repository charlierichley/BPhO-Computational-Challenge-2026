...
Simplifying to $\frac{m_n}{m_e}$ = 1839 so the ratio of their velocities is the same as the ratio of their kinetic energies.
...
The time-independent Schrödinger equation (with $V=0$ as we are inside the box) is $
...
$\Delta x= \sqrt{\frac{1}{3}a^2(1-\frac{3}{2n^2\pi ^2}) -\frac{1}{4}a^2} = \sqrt{\frac{a^2}{12} - \frac{a^2}{2n^2\pi^2}} = a\sqrt{\frac{n^2\pi^2 - 6}{12n^2\pi^2}} = \frac{a}{2n\pi}\sqrt{\frac{n^2\pi^2}{3} - 2}$
